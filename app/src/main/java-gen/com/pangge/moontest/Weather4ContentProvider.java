...
/* Copy this code snippet into your AndroidManifest.xml inside the <application> element:
    ...
    <provider
        android:name="com.pangge.moontest.Weather4ContentProvider"
        android:authorities="com.pangge.moontest.provider" />
*/

public class Weather4ContentProvider extends ContentProvider {

    public static final String AUTHORITY = "com.pangge.moontest.provider";
    public static final String BASE_PATH = "weather4";
    ...
    private static final String TABLENAME = Weather4Dao.TABLENAME;
    private static final String PK = Weather4Dao.Properties.Id.columnName;

    private static final int WEATHER4_DIR = 0;
    private static final int WEATHER4_ID = 1;

    private static final UriMatcher sURIMatcher;

    static {
        sURIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH, WEATHER4_DIR);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", WEATHER4_ID);
    }
