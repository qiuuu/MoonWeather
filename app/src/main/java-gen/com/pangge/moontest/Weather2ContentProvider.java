...
/* Copy this code snippet into your AndroidManifest.xml inside the <application> element:
    ...
    <provider
        android:name="com.pangge.moontest.Weather2ContentProvider"
        android:authorities="com.pangge.moontest.provider" />
*/

public class Weather2ContentProvider extends ContentProvider {

    public static final String AUTHORITY = "com.pangge.moontest.provider";
    public static final String BASE_PATH = "weather2";
    ...
    private static final String TABLENAME = Weather2Dao.TABLENAME;
    private static final String PK = Weather2Dao.Properties.Id.columnName;

    private static final int WEATHER2_DIR = 0;
    private static final int WEATHER2_ID = 1;

    private static final UriMatcher sURIMatcher;

    static {
        sURIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH, WEATHER2_DIR);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", WEATHER2_ID);
    }
