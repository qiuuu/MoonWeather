...
/** 
 * DAO for table "WEATHER4".
*/
public class Weather4Dao extends AbstractDao<Weather4, Long> {

    public static final String TABLENAME = "WEATHER4";

    /**
     * Properties of entity Weather4.<br/>
    ...
    public Weather4Dao(DaoConfig config) {
        super(config);
    }
    
    public Weather4Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WEATHER4\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WEATHER4\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Weather4 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Weather4 entity) {
        stmt.clearBindings();
    ...
    @Override
    public Weather4 readEntity(Cursor cursor, int offset) {
        Weather4 entity = new Weather4( //
    ...
    @Override
    public void readEntity(Cursor cursor, Weather4 entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Weather4 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Weather4 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Weather4 entity) {
