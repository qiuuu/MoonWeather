...
/* Copy this code snippet into your AndroidManifest.xml inside the <application> element:
    ...
    <provider
        android:name="com.pangge.moontest.Weather5ContentProvider"
        android:authorities="com.pangge.moontest.provider" />
*/

public class Weather5ContentProvider extends ContentProvider {

    public static final String AUTHORITY = "com.pangge.moontest.provider";
    public static final String BASE_PATH = "weather5";
    ...
    private static final String TABLENAME = Weather5Dao.TABLENAME;
    private static final String PK = Weather5Dao.Properties.Id.columnName;

    private static final int WEATHER5_DIR = 0;
    private static final int WEATHER5_ID = 1;

    private static final UriMatcher sURIMatcher;

    static {
        sURIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH, WEATHER5_DIR);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", WEATHER5_ID);
    }
