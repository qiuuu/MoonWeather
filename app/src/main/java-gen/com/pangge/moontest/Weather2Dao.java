...
/** 
 * DAO for table "WEATHER2".
*/
public class Weather2Dao extends AbstractDao<Weather2, Long> {

    public static final String TABLENAME = "WEATHER2";

    /**
     * Properties of entity Weather2.<br/>
    ...
    public Weather2Dao(DaoConfig config) {
        super(config);
    }
    
    public Weather2Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WEATHER2\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WEATHER2\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Weather2 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Weather2 entity) {
        stmt.clearBindings();
    ...
    @Override
    public Weather2 readEntity(Cursor cursor, int offset) {
        Weather2 entity = new Weather2( //
    ...
    @Override
    public void readEntity(Cursor cursor, Weather2 entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Weather2 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Weather2 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Weather2 entity) {
