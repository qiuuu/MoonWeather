...
/** 
 * DAO for table "WEATHER3".
*/
public class Weather3Dao extends AbstractDao<Weather3, Long> {

    public static final String TABLENAME = "WEATHER3";

    /**
     * Properties of entity Weather3.<br/>
    ...
    public Weather3Dao(DaoConfig config) {
        super(config);
    }
    
    public Weather3Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WEATHER3\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WEATHER3\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Weather3 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Weather3 entity) {
        stmt.clearBindings();
    ...
    @Override
    public Weather3 readEntity(Cursor cursor, int offset) {
        Weather3 entity = new Weather3( //
    ...
    @Override
    public void readEntity(Cursor cursor, Weather3 entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Weather3 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Weather3 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Weather3 entity) {
