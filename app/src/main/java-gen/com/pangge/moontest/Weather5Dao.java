...
/** 
 * DAO for table "WEATHER5".
*/
public class Weather5Dao extends AbstractDao<Weather5, Long> {

    public static final String TABLENAME = "WEATHER5";

    /**
     * Properties of entity Weather5.<br/>
    ...
    public Weather5Dao(DaoConfig config) {
        super(config);
    }
    
    public Weather5Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WEATHER5\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WEATHER5\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Weather5 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Weather5 entity) {
        stmt.clearBindings();
    ...
    @Override
    public Weather5 readEntity(Cursor cursor, int offset) {
        Weather5 entity = new Weather5( //
    ...
    @Override
    public void readEntity(Cursor cursor, Weather5 entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Weather5 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Weather5 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Weather5 entity) {
